"""
Django settings for testappe_3 project.
...
WSGI_APPLICATION = 'testappe_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testappe_3 API",
    "DESCRIPTION": "API documentation for testappe_3 App",
    "VERSION": "v1",
}
